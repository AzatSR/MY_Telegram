package com.azat.telegramaz.database
...
fun initFireBase() {
    ...
    USER = UserModel()
    REF_DATABASE_ROOT = FirebaseDatabase.getInstance("https://telegram-project-9517c-default-rtdb.europe-west1.firebasedatabase.app")
        .reference
